...
& C:/Qt/6.3.1/msvc2019_64/bin/windeployqt.exe --qmldir C:/Qt/6.3.1/msvc2019_64/qml build/Release
New-Item -ItemType Directory -Force -Path build/Release/Qt/labs/platform
Copy-Item -Path C:/Qt/6.3.1/msvc2019_64/qml/Qt/labs/platform/* -Destination build/Release/Qt/labs/platform/ -Recurse
